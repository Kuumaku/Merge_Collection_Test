...
exports.merge_collection = merge_collection;
function merge_collection(collection1, collection2, collection3) {
    ...
    while (i < C1_l //while collection 1 still not done traversing
        ...
        let C1_V = Infinity; //Values to store number of collection1 at index i
        let C2_V = Infinity; //Values to store number of collection2 at index j
        let C3_V = Infinity; //Values to store number of collection3 at index k
